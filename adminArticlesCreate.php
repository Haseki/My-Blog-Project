...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $result = insertDB("articles(title , summary , content , img_name , img_dir)", "(\"$title\" , \"$sum\" , \"$content\" , \"$fname\" , \"$file_dir\")");
...
<div class="article_blue_form">
    <form method="POST" action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>" enctype="multipart/form-data">
            ...
            <div class="article_text_field" style = "margin-left: 450px;">
                ...
                <br>
                <textarea cols="60" rows="20" name="content" class="art_textfield_form" >Content</textarea>
                <br>
